...
public class Constants {
    ...
    // FIXME: please change to your valid api domain for test, for example: foxdigital.vip
    public static final String BASE_DOMAIN = "";

    // REST api url format: https://api.BASE_DOMAIN
    // for example: https://api.foxdigital.vip
    ...
    // for example: wss://wsapi.foxdigital.vip/openapi/quote/ws/v1
    ...
    // for example: wss://wsapi.foxdigital.vip/openapi/ws
